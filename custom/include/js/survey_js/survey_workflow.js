        ...
        success: function (result_module) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $('#survey_main_div').append('<img src="themes/Sugar5/images/loading.gif" id="loading-image"  class="ajax-loader" style="display:none; left: 30%; top: 70%; position: absolute;"/>');
                    var arr;
...
function show_module_list(el) {
    ...
    var apiData = {module: 'bc_automizer_actions', action: 'getsurvey', record: record_id, action_id: action_id};
    $('#loading-image').show();
    $.ajax({
        url: "index.php",
        data: apiData,
