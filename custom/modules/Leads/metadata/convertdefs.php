        ...
        'panels' =>array (
            'LNK_NEW_CONTACT' => array (
                array (
                    array (
                        'name' => 'name', 
                        'customCode' => '<input name="Contactslast_name" id="Contactslast_name" placeholder="{$MOD.LBL_LAST_NAME|replace:\':\':\'\'}" style="width:120px !important" size="15" type="text"  value="{$fields.last_name.value}">
