...
$html.= "<tr height='20'><th scope='col' align='center' class='reportlistViewMatrixThS1' valign='middle' wrap=''>STT</th>";
...
$html .= "<th  scope='col' align='center' class='reportlistViewMatrixThS1' valign='middle' wrap=''>Parent</th>";
...
while($row = $GLOBALS['db']->fetchbyAssoc($result)){
    $count++;
    $html.= "<tr height='20'><td scope='col' align='center' class='reportGroupByDataMatrixEvenListRowS1' valign='middle' wrap=''>$count</td>";
    $html .= "<td  scope='col' align='center' class='reportGroupByDataMatrixEvenListRowS1' valign='middle' wrap=''>{$row['student_code']}</td>";
    $html .= "<td  scope='col' align='center' class='reportGroupByDataMatrixEvenListRowS1' valign='middle' wrap=''><a href='index.php?module=Contacts&action=DetailView&record={$row['student_id']}' target='_blank'>{$row['student_name']}</td>";
    $html .= "<td  scope='col' align='center' class='reportGroupByDataMatrixEvenListRowS1' valign='middle' wrap=''>{$row['parent_name']}</td>";
    $html .= "<td  scope='col' align='center' class='reportGroupByDataMatrixEvenListRowS1' valign='middle' wrap=''>{$row['phone_mobile']}</td>";
    $html .= "<td  scope='col' align='center' class='reportGroupByDataMatrixEvenListRowS1' valign='middle' wrap=''>{$row['class_code']}</td>";
    $html .= "<td  scope='col' align='center' class='reportGroupByDataMatrixEvenListRowS1' valign='middle' wrap=''>{$row['class_name']}</td>";
    $html .= "<td  scope='col' align='center' class='reportGroupByDataMatrixEvenListRowS1' valign='middle' wrap=''>{$timedate->to_display_date($row['start_study'],false)}</td>";
    $html .= "<td  scope='col' align='center' class='reportGroupByDataMatrixEvenListRowS1' valign='middle' wrap=''>{$timedate->to_display_date($row['last_lesson_date'],false)}</td>";
    $html .= "<td  scope='col' align='center' class='reportGroupByDataMatrixEvenListRowS1' valign='middle' wrap=''>{$timedate->to_display_date($row['class_end_date'],false)}</td>";
    $html .= "<td  scope='col' align='center' class='reportGroupByDataMatrixEvenListRowS1' valign='middle' wrap=''>".format_number($row['unused_hours'],2,2)."</td>";
    $html .= "<td  scope='col' align='center' class='reportGroupByDataMatrixEvenListRowS1' valign='middle' wrap=''>".format_number($row['unused_amount'],2,2)."</td>";
    $html .= "<td  scope='col' align='center' class='reportGroupByDataMatrixEvenListRowS1' valign='middle' wrap=''>{$row['kind_of_course']}</td>";
    $html .= "<td  scope='col' align='center' class='reportGroupByDataMatrixEvenListRowS1' valign='middle' wrap=''>{$row['class_assigned']}</td></tr>";
    $html.='</tr>';
}
$html .= "</tbody></table>";
echo $html;
