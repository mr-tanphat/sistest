<?php
    ...
    class ViewConfigEnquires  extends SugarView{
        function ViewConfigEnquires() {
            parent::display();
        }
        ...
        function display() {
            ...
            $html .= '</select>';
            $ss->assign("LBL_CONFIG_TITLE",$GLOBALS['mod_strings']['LBL_SET_TARGET_ENQUIRES']);
            $ss->assign("target_type","Target Enquiries");
            $ss->assign("html",$html);
