...
function ajaxCheckTeacher(){
    ...
    $.ajax({
        url: "index.php?module=C_Classes&action=ajaxCheckTeacher&sugar_body_only=true",
        type: "POST",
        async: true,
        data:  
        {
...
function validateElements(){
    if(validate['CheckTeacherForm']!='undefined'){delete validate['CheckTeacherForm']};

    addToValidate('CheckTeacherForm', 'start_time', 'time', true, SUGAR.language.get('C_Classes','LBL_START_TIME') );
    addToValidate('CheckTeacherForm', 'end_time', 'time', true, SUGAR.language.get('C_Classes','LBL_END_TIME') ); 

    addToValidate('CheckTeacherForm', 'end_date', 'date', true, SUGAR.language.get('C_Classes','LBL_END_DATE') );
   // addToValidate('CheckTeacherForm', 'teacher_id', 'enum', true, SUGAR.language.get('C_Classes','LBL_TEACHER_NAME') );
    addToValidateDateBefore('CheckTeacherForm','start_date','date',true,SUGAR.language.get('C_Classes','LBL_START_DATE'),'end_date');
    ...
    if(weekday.length == 0){
        addToValidate('CheckTeacherForm', 'validate_weekday', 'varchar', true,  SUGAR.language.get('C_Classes','LBL_DAY')); 
    }
    return check_form('CheckTeacherForm');
}
