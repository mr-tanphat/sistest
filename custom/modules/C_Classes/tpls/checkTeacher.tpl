{sugar_getscript file="custom/modules/C_Classes/js/checkTeacher.js"}
...
<form action="" method="POST" name="CheckTeacherForm" id="CheckTeacherForm">
    <div class="container">
        <div class="page-header">
            <h1>{$MOD.LBL_CT_TITLE}</h1>
        </div>
...
<!--                <tr>
                    <td width='15%' nowrap>
                        <b>{$MOD.LBL_TEACHER_NAME}: <span class="required">*</span> </b>
                    </td>
                    <td NOWRAP colspan='3'>
                        {$TEACHER_OPTION}
                   </td>
