...
$hook_array['before_save'][] = Array(3, 'Add Auto-Increment Code', 'custom/modules/J_Payment/logicPayment.php','logicPayment', 'addCode'); 
$hook_array['before_save'][] = Array(4, 'Import Payment', 'custom/modules/J_Payment/logicImport.php','logicImport', 'importPayment'); 
