        ...
        array (
            ...
            array (
                ...
                array (
                    ...
                    7 => '<input type="hidden" name="study_date" id="study_date" value="{$fields.study_date.value}">',
                    8 => '<input type="hidden" name="study_time_date" id="study_time_date" value="{$fields.study_time_date.value}">',
                    9 => '<input type="hidden" name="history_temp" id="history_temp" value="">',
                    10 => '<input type="hidden" name="class_type" id="class_type" value="{$fields.class_type.value}">',
                    11 => '<input type="hidden" name="aims_id" id="aims_id" value="{$fields.aims_id.value}">',
                    12 => '<input type="hidden" name="fetched_row_j_class_j_class_1j_class_ida" id="fetched_row_j_class_j_class_1j_class_ida" value="{$fields.j_class_j_class_1j_class_ida.value}">',
                    //                    13 => '<input type="hidden" name="lesson_final_test" id="lesson_final_test" value="{$fields.lesson_final_test.value}">',
                    14 => '<input type="hidden" name="upgrade_to_id" id="upgrade_to_id" value="{$upgrade_to_id}">',
                    15 => '<input type="hidden" name="upgrade_to_name" id="upgrade_to_name" value="{$upgrade_to_name}">',
                    16 => '<input type="hidden" id="koc_id" name="koc_id" value="{$fields.koc_id.value}">',
                    17 => '<input type="hidden" id="team_type" name="team_type" value="{$team_type}">',
                    18 => '<input type="hidden" id="accept_schedule_change" name="accept_schedule_change" value="0"/>{include file="custom/modules/J_Class/tpls/situationNotify.tpl"}',
                ),
            ),
            'maxColumns' => '2',
            'widths' =>
            ...
            {else}
            {sugar_getscript file="custom/modules/J_Class/js/editviewww.js"}
            {/if}
        ...
        array (
            ...
            array (
                ...
                array (
                    ...
                    array (
                        'name' => 'status',
                        'customCode' => '<label id="status">{$fields.status.value}</label>',
                    ),
                ),
                1 =>
                array (
                ...
                array (
                    ...
                    array (
                        'name' => 'hours',
                        'label' => 'LBL_HOURS',
                        'customCode' => '<input  type="text" class="input_readonly" name="hours" id="hours"  maxlength="5" value="{$fields.hours.value}" title="{$MOD.LBL_HOURS}" tabindex="0" size="5" readonly>',
                    ),
                    1 =>
                    array (
                        'name' => 'end_date',
