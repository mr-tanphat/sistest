...
<div id="dialog_teacher" title="Schedule Teacher" style="display:none;">
    <table style="border: 1px solid #F0F0F0;width:100%;">
        ...
        <tr>
            ...
            <td colspan="3">
                <input type=checkbox class="day_of_week" id='Monday' onclick='clearTeacherList();'/><label style="margin-right:10px;" id="lbl_mon">{$MOD.LBL_MON}</label>
                <input type=checkbox class="day_of_week" id='Tuesday' onclick='clearTeacherList();'/><label style="margin-right:10px;" id="lbl_tue">{$MOD.LBL_TUE}</label>
                <input type=checkbox class="day_of_week" id='Wednesday' onclick='clearTeacherList();'/><label style="margin-right:10px;" id="lbl_wed">{$MOD.LBL_WED}</label>
                <input type=checkbox class="day_of_week" id='Thursday' onclick='clearTeacherList();'/><label style="margin-right:10px;" id="lbl_thu">{$MOD.LBL_THU}</label>
                <input type=checkbox class="day_of_week" id='Friday' onclick='clearTeacherList();'/><label style="margin-right:10px;" id="lbl_fri">{$MOD.LBL_FRI}</label>
                <input type=checkbox class="day_of_week" id='Saturday' onclick='clearTeacherList();'/><label style="margin-right:10px;" id="lbl_sat">{$MOD.LBL_SAT}</label>
                <input type=checkbox class="day_of_week" id='Sunday' onclick='clearTeacherList();'/><label style="margin-right:10px;" id="lbl_sun">{$MOD.LBL_SUN}</label>
            </td>
        </tr>
        <tr>
