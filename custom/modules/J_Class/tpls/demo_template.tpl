<div id="diaglog_demo" title="Add Demo" style="display:none;">
    <table width="100%"  class="edit view">
        ...
        <input type="hidden" id="dm_student_id" value="{$dm_student_id}">
            ...
            <td><span class="dateTime"><input disabled id="dm_lesson_date" name="dm_lesson_date" size="10" type="text" value="{$today}">  <img border="0" src="custom/themes/default/images/jscalendar.png" alt="Enter Date" id="dm_lesson_date_trigger" align="absmiddle"></span></td>
            </tr>
            <tr>
                <td style="colspan=4;">
