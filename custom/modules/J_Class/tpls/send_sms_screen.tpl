            ...
            <tbody>
                ...
                <tr>
                    <td colspan="3" nowrap align='center'>
                        <input type="button" class="button primary" id="btn_generate" value="{$MOD.LBL_GENERATE}" style="padding: 6px 10px 6px 10px;"></input>
                        <input type="button" class="button" id="recent_sms" value="Recent SMS" onclick="showRecentSMS();" style="padding: 6px 10px 6px 10px;">
                    </td>
                </tr>
            </tbody>
        </table>
        <table class="tbl student_list" id="tbl_student" width="90%"> 
            <thead>
                <tr>
                    ...
                    <th width="20%" style="padding-top: 10px;padding-bottom: 10px;">
                        <input type="button" class="button primary"  id="btn_send_all" value="{$MOD.LBL_SEND_ALL}" style="padding: 6px 10px 6px 10px;"></input>
                    </th>
                </tr>
            </thead>
            <tbody>
