...
//            return ;
    ...
    $('#add_out_btn').live('click', function(){
        ...
        $('#start_outstanding').val(get_default_ot_start_date());
...
function get_default_ot_start_date(){
    var today_date = SUGAR.util.DateUtils.formatDate(new Date());
    var default_start_ot = today_date;
    var today_dates_str = SUGAR.util.DateUtils.parse(today_date,cal_date_format).getTime();
    var class_start_date = SUGAR.util.DateUtils.parse($('#start_date').text(),cal_date_format).getTime();
    if (today_dates_str < class_start_date) default_start_ot = $('#start_date').text();

    return default_start_ot;
}
