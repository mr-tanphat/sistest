        ...
        array (
          ...
          array (
            ...
            'label' => 'LBL_DISCOUNT_DAYS',
             'customCode' => '<input type="text" tabindex="0" size="4" maxlength="10" class="currency" name="discount_days" id="discount_days"  value="{$fields.discount_days.value}" title="{$MOD.LBL_DISCOUNT_DAYS}"> <b> days</b>',
          ),
          1 => '',
        ),
        5 => 
