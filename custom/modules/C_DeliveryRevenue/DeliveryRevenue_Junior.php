<?php
function calDeliveryJunior($start , $end , $team_id = '', $student_id = '', $class_id = '', $type = 'Normal', $status = '', $payment_id = ''){
    ...
    $GLOBALS['db']->query($q1);
    $team_type = $GLOBALS['db']->getOne("SELECT team_type FROM teams where id = '$team_id'");
    if($team_type == 'Adult'){
