		...
		array (
			...
			array (
				...
				array (
					...
					array (
						'customCode' => '
						<button type="submit" id = "send_email">{$MOD.LBL_SEND_SCHEDULE_EMAIL}</button>                
						...
						array (
							'type' => 'submit',
							'value' => '{$MOD.LBL_SEND_SCHEDULE_EMAIL}',
							'htmlOptions' => 
							array (
								'title' => '{$MOD.LBL_SEND_SCHEDULE_EMAIL}',
								'accesskey' => '',
								'class' => 'button',
								'name' => '{$MOD.LBL_SEND_SCHEDULE_EMAIL}',
								'id' => 'send_email',
							),
						),
					),
