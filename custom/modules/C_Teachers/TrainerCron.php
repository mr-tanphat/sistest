<?php
    class TrainerCron{
        function create_pdf_tc(){
            ...
            $pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, 'Teaching Schedule - Teacher '.$teacher_name,"ApolloCRM - APOLLO English\nWHERE THE BEST BECOME BETTER");
            $pdf->Ln();
            $pdf->Ln();
            $pdf->Ln();
            $pdf->Ln();
        ...
        function send_mail_tc(){
            ...
            $mail->Subject = '[Apollo English] Teaching Schedule for '.vn_str_filter($gv->name);
            $mail->Body    = 'Dear <b>'.vn_str_filter($gv->name).'!</b><br>ApolloCRM send you a PDF file, this is teaching schedule for you on this month.<br> Thank you!';
