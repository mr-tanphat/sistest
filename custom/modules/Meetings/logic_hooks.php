<?php
    ...
    $hook_array['before_save'][] = Array(4, 'Save Testing', 'custom/modules/Meetings/handleSaveMeeting.php', 'handleSaveMeetings', 'handleSavePT');
    $hook_array['before_save'][] = Array(5, 'Add Auto-Increment Code', 'custom/modules/Meetings/handleSaveMeeting.php','handleSaveMeetings', 'addCode');
