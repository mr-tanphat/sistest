    ...
    <table id="diagnosis_list_demo" width="100%" border="0" class="list view"> 
        <thead>
            ...
            <tr>
                ...
                <th style="text-align: center;width: 10%;"><span sugar="slot12" style="white-space:normal;">{$MOD.LBL_SESSION_STATUS}</span></th>
                <th style="text-align: center;width: 15%;"><span sugar="slot12" style="white-space:normal;">{$MOD.LBL_BIRTHDAY}</span></th>
                <th style="text-align: center;width: 10%;"><span sugar="slot12" style="white-space:normal;">{$MOD.LBL_GENDER}</span></th>
                <th style="text-align: center;width: 15%;"><span sugar="slot12" style="white-space:normal;">{$MOD.LBL_PHONE}</span></th>
                ...
                <th style="text-align: center;width: 15%;"><span sugar="slot12" style="white-space:normal;">{$MOD.LBL_EMAIL}</span></th>
