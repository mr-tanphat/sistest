...
function clickChooseStudentDemo(){
    ...
    open_popup(module,600, 400, "", true, false, {"call_back_function":"set_return_parent_demo","form_name":"DetailView","field_to_name_array":{"name":"name","id":"id","birthdate":"birthdate","gender":"gender","phone_mobile":"phone_mobile","email1":"email1","status":"status","school_name":"school_name","contact_status":"contact_status","assigned_user_name":"assigned_user_name"}}, "single", true);
}
...
function set_return_parent_demo(popup_reply_data, filter) {
    ...
    if(check){
        ...
        _lastrow.find('.attended').prop('checked',true);
        _lastrow.find('.check_attended').val(1);
