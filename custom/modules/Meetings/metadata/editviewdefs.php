                ...
                array (
                    ...
                    array (
                        ...
                        array (
                            'name' => 'teacher_name',
                            'customCode' => '
                            {html_options name="teacher_id" id="teacher_id" options=$fields.teacher_id.options selected=$fields.teacher_id.value}                            
                            <input id="find_teacher" class="button primary" type="button" name="find_teacher" value="'.$mod_strings["LBL_FIND_TEACHER"].'" style="width: 50px;">
                            ',
                        ),
                    ...
                    array (
                        ...
                        array (
                            'name' => 'teaching_hour',
                            'customCode' => '<input tabindex="0" type="text" name="teaching_hour" id="teaching_hour" maxlength="100" size="15" value="{sugar_number_format var=$fields.teaching_hour.value precision=2}">',
                        ),
                    ),
                    6 => 
                    array (
                ...
                array (
                    ...
                    array (
                        ...
                        array (
                            ...
                            'customCode' => '
                            {html_options name="teacher_id" id="teacher_id" options=$fields.teacher_id.options selected=$fields.teacher_id.value}                            
                            <input id="find_teacher" class="button primary" type="button" name="find_teacher" value="'.$mod_strings["LBL_FIND_TEACHER"].'" style="width: 100px;">
                            ',
                        ),
                    ...
                    array (
                        ...
                        array (
                            ...
                            'customCode' => '
                            {html_options name="room_id" id="room_id" options=$fields.room_id.options selected=$fields.room_id.value}
                            <input id="find_room" class="button primary" type="button" name="find_room" value="'.$mod_strings["LBL_FIND_ROOM"].'" style="width: 100px;">
                            ',
                        ),
