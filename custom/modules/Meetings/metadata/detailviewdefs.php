            ...
            array (
                ...
                array (
                    ...
                    array (
                        ...
                        array (
                            'name' => 'delivery_hour',
                            'customLabel' => '{if $fields.meeting_type.value == "Session" || $fields.meeting_type.value == "Placement Test" || $fields.meeting_type.value == "Demo"}Revenue Hours:<br>Teaching Hours:{/if}',
                            'customCode' => '{if $fields.meeting_type.value == "Session" || $fields.meeting_type.value == "Placement Test" || $fields.meeting_type.value == "Demo"}
                            <label>{$fields.delivery_hour.value}</label><br><label> {$fields.teaching_hour.value}</label>
                            {/if}
                            '
                        ),
                        1 => 
                ...
                array (
                    ...
                    array (
                        ...
                        array (
                            'name' => 'delivery_hour',
                            'customLabel' => 'Revenue Hours:<br>Teaching Hours:',
                            'customCode' => '
                            <label>{$fields.delivery_hour.value}</label><br><label> {$fields.teaching_hour.value}</label>
                            '
                        ),
