...
$(document).ready(function(){
    ...
    $('#lead_source').select2({width: '250px'});
    $('#preferred_kind_of_course').select2({width: '250px'});
    ...
    $('#select, .select_rela, .student_name').live('change',function(){
    ...
    $('#password_generated_label1').text('apollo123456');
    //end edit
