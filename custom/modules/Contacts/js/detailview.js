...
function ajaxResetPassword(){
    ...
    ajaxStatus.showStatus('Resetting Password <img src="custom/include/images/loader32.gif" align="absmiddle" width="32">'); //Sugar alert
    $.ajax({
...
function ajaxStopStudent(){
    ajaxStatus.showStatus('Checking student <img src="custom/include/images/loader32.gif" align="absmiddle" width="32">'); //Sugar alert
    $.ajax({
        ...
        success:function(data){
            ajaxStatus.hideStatus();
            if(data != 1) {
                alertify.error('Stop student not successfully');
            }
            else {
                alertify.success('Stop student successfully');
                location.reload();
            }
