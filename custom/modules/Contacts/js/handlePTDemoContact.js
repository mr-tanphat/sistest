...
/////////////////////------Apollo Junior: Save PT Demo From Module Student By Quyen.Cao-------/////////////////
$(document).ready(function(){
    $('.remove_pt').live('click',function(){
        var pt_id = this.getAttribute('id');
        if(confirm("Are you sure to remove current student from this PT?")){
            ajaxRemovePTFromStudent(pt_id);
        }
    });
    $('.remove_demo').live('click',function(){
        var meeting_id = this.getAttribute('id');
        if(confirm("Are you sure to remove current student from this Demo?")){
            ajaxRemoveDemoFromStudent(meeting_id);
        }
    });
});
...
function handleSelect_contact_demo(){
    open_popup("Meetings",600, 400, "", true, false, {"call_back_function":"set_return_demo_contact","form_name":"DetailView","field_to_name_array":{"id":"id", "meeting_type":"meeting_type"}}, "single", true, 'popupfordemodefs');
}
...
function handleSelect_contact_pt(){
    open_popup("Meetings",600, 400, "", true, false, {"call_back_function":"set_return_pt_contact","form_name":"DetailView","field_to_name_array":{"id":"id", "meeting_type":"meeting_type"}}, "single", true,'popupforptdefs');
}
...
/////////////////////------End Apollo Junior: Save PT Demo From Module Student By Quyen.Cao---------/////////////////