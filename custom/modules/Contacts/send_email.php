<?php
    ...
    $mail->Subject = '[Apollo CRM] Here is your Username and Password login to Student Portal !'.$name;
    $mail->Body    = 'Dear <b>'.vn_str_filter($ct->name).'!</b><br>Your Username is: '.$_POST['username'].'<br>Password : '.$_POST['password'].'<br> Now, you can access to the student portal. Go to http://portal360.apollo.edu.vn and log in with your account !';
    if(!$mail->Send()) 
    {
