...
$hook_array['before_save'][] = Array(0, 'Add Code', 'custom/modules/Contacts/logicStudent.php','logicStudent', 'addCode'); 
...
$hook_array['after_save'][] = Array(2, 'Auto Generate Account Portal', 'custom/modules/Contacts/logicStudent.php','logicStudent', 'autoGenerateAccountPortal'); 
