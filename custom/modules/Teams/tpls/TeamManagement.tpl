    ...
    <div id="Content">
        <div class="panel">
            <div class="action_buttons">
                ...
                <input style="margin-left:20px; display:none;" class="button" style="display:none;" type="button" name="{$APPS.LBL_DELETE_BUTTON}" value="{$APPS.LBL_DELETE_BUTTON}" id="delete_bt">
            ...
            <form method="POST" name="TeamEdit" id="TeamEdit">
                ...
                <table width="100%" border="0" style="display:inline-table;font-size:15px;" cellspacing="1" class="panelContainer" cellpadding="0">
                    <tbody>
                        ...
                        <tr>
                            <td valign="top" id="team_type_label" align="left" width="12%" scope="col" style="padding-top:20px;">
                                {$MOD.LBL_TEAM_TYPE}:
                            </td>
                            <td valign="top" width="70%" style="padding-top:20px;">
