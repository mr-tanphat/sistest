    ...
    */
    public function display()
    {
        ...
        if($_REQUEST['import_module'] == 'Leads'){
            $download_url = 'index.php?entryPoint=download&id=8e350364-ea3d-91b5-0d42-57a9398964d9&type=Documents'; 
        }elseif($_REQUEST['import_module'] == 'Prospects'){                                                          
            $download_url = 'index.php?entryPoint=download&id=aefc043f-5148-eda7-3285-57a93af680ee&type=Documents';  
        }elseif($_REQUEST['import_module'] == 'J_School'){
            $download_url = 'index.php?entryPoint=download&id=47a1a6f3-bb46-4efc-d248-57a93a310b16&type=Documents';
        }else
