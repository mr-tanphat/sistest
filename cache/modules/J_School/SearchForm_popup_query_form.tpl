...
<tr>
		...
		{if $fields.short_name_advanced.acl > 0}
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='short_name_advanced'>{sugar_translate label='LBL_SHORT_NAME' module='J_School'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
{if strlen($fields.short_name_advanced.value) <= 0}
{assign var="value" value=$fields.short_name_advanced.default_value }
{else}
{assign var="value" value=$fields.short_name_advanced.value }
{/if}  
<input type='text' name='{$fields.short_name_advanced.name}' 
    id='{$fields.short_name_advanced.name}' size='30' 
    maxlength='150' 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='level_advanced'>{sugar_translate label='LBL_LEVEL' module='J_School'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
{html_options id='level_advanced' name='level_advanced[]' options=$fields.level_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.level_advanced.value}
		...
		{if $fields.address_address_street_advanced.acl > 0}
		{counter assign=index}
	{math equation="left % right"
   		  left=$index
          right=$templateMeta.maxColumns
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='address_address_street_advanced'>{sugar_translate label='LBL_ADDRESS_STREET' module='J_School'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
{if strlen($fields.address_address_street_advanced.value) <= 0}
{assign var="value" value=$fields.address_address_street_advanced.default_value }
{else}
{assign var="value" value=$fields.address_address_street_advanced.value }
{/if}  
<input type='text' name='{$fields.address_address_street_advanced.name}' 
    id='{$fields.address_address_street_advanced.name}' size='30' 
    maxlength='100' 
    value='{$value}' title=''      >
   	   	</td>
					{/if}
		...
		{if $fields.address_address_state_advanced.acl > 0}
		{counter assign=index}
	{math equation="left % right"
   		  left=$index
          right=$templateMeta.maxColumns
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='address_address_state_advanced'>{sugar_translate label='LBL_ADDRESS_STATE' module='J_School'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
{if strlen($fields.address_address_state_advanced.value) <= 0}
{assign var="value" value=$fields.address_address_state_advanced.default_value }
{else}
{assign var="value" value=$fields.address_address_state_advanced.value }
{/if}  
<input type='text' name='{$fields.address_address_state_advanced.name}' 
    id='{$fields.address_address_state_advanced.name}' size='30' 
    maxlength='100' 
    value='{$value}' title=''      >
   	   	</td>
					{/if}
		...
		{if $fields.address_address_city_advanced.acl > 0}
		{counter assign=index}
	{math equation="left % right"
   		  left=$index
          right=$templateMeta.maxColumns
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='address_address_city_advanced'>{sugar_translate label='LBL_ADDRESS_CITY' module='J_School'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
{if strlen($fields.address_address_city_advanced.value) <= 0}
{assign var="value" value=$fields.address_address_city_advanced.default_value }
{else}
{assign var="value" value=$fields.address_address_city_advanced.value }
{/if}  
<input type='text' name='{$fields.address_address_city_advanced.name}' 
    id='{$fields.address_address_city_advanced.name}' size='30' 
    maxlength='100' 
    value='{$value}' title=''      >
   	   	</td>
					{/if}
