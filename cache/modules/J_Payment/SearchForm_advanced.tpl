...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
			<label for='name_advanced'>{sugar_translate label='LBL_NAME' module='J_Payment'}</label>
		</td>
...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    value='{$value}' title=''      accesskey='9'  >
		...
		{if $fields.contacts_j_payment_1_name_advanced.acl > 0}
		{counter assign=index}
	{math equation="left % right"
   		  left=$index
          right=$templateMeta.maxColumns
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='contacts_j_payment_1_name_advanced'>{sugar_translate label='LBL_CONTACTS_J_PAYMENT_1_FROM_CONTACTS_TITLE' module='J_Payment'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="{$fields.contacts_j_payment_1_name_advanced.name}"  class="sqsEnabled"   id="{$fields.contacts_j_payment_1_name_advanced.name}" size="" value="{$fields.contacts_j_payment_1_name_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.contacts_j_payment_1contacts_ida_advanced.name}" value="{$fields.contacts_j_payment_1contacts_ida_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.contacts_j_payment_1_name_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.contacts_j_payment_1_name_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"contacts_j_payment_1contacts_ida_advanced","name":"contacts_j_payment_1_name_advanced"}}{/literal}, "single", true);'>{sugar_getimage alt=$app_strings.LBL_ID_FF_SELECT name="id-ff-select" ext=".png" other_attributes=''}</button><button type="button" name="btn_clr_{$fields.contacts_j_payment_1_name_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.contacts_j_payment_1_name_advanced.name}.value = ''; this.form.{$fields.contacts_j_payment_1contacts_ida_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}">{sugar_getimage name="id-ff-clear" alt=$app_strings.LBL_ID_FF_CLEAR ext=".png" other_attributes=''}</button>
</span>
		...
		{if $fields.payment_type_advanced.acl > 0}
		{counter assign=index}
	{math equation="left % right"
   		  left=$index
          right=$templateMeta.maxColumns
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='payment_type_advanced'>{sugar_translate label='LBL_PAYMENT_TYPE' module='J_Payment'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='payment_type_advanced' name='payment_type_advanced[]' options=$fields.payment_type_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.payment_type_advanced.value}
   	   	</td>
					{/if}
		...
		{if $fields.payment_date_advanced.acl > 0}
		{counter assign=index}
	{math equation="left % right"
   		  left=$index
          right=$templateMeta.maxColumns
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='payment_date_advanced'>{sugar_translate label='LBL_PAYMENT_DATE' module='J_Payment'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{assign var="id" value=$fields.payment_date_advanced.name }

{if isset($smarty.request.payment_date_advanced_range_choice)}
{assign var="starting_choice" value=$smarty.request.payment_date_advanced_range_choice}
{else}
...
{html_options options=$fields.payment_date_advanced.options selected=$starting_choice}
</select>
</div>

<div id="{$id}_range_div" style="{if preg_match('/^\[/', $smarty.request.range_payment_date_advanced)  || $starting_choice == 'between'}display:none{else}display:''{/if};">
<input autocomplete="off" type="text" name="range_{$id}" id="range_{$id}" value='{if empty($smarty.request.range_payment_date_advanced) && !empty($smarty.request.payment_date_advanced)}{$smarty.request.payment_date_advanced}{else}{$smarty.request.range_payment_date_advanced}{/if}' title='Payment Date'   size="11" style="width:100px !important;">
...
{assign var=date_value value=$fields.payment_date_advanced.value }
<input autocomplete="off" type="text" name="start_range_{$id}" id="start_range_{$id}" value='{$smarty.request.start_range_payment_date_advanced }' title='Payment Date'  tabindex='' size="11" style="width:100px !important;">
...
{$APP.LBL_AND}
{assign var=date_value value=$fields.payment_date_advanced.value }
<input autocomplete="off" type="text" name="end_range_{$id}" id="end_range_{$id}" value='{$smarty.request.end_range_payment_date_advanced }' title='Payment Date'  tabindex='' size="11" style="width:100px !important;" maxlength="10">
...
{rdelim});
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='date_entered_advanced'>{sugar_translate label='LBL_DATE_ENTERED' module='J_Payment'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{rdelim});
		...
		{if $fields.date_modified_advanced.acl > 0}
		{counter assign=index}
	{math equation="left % right"
   		  left=$index
          right=$templateMeta.maxColumns
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='date_modified_advanced'>{sugar_translate label='LBL_DATE_MODIFIED' module='J_Payment'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{rdelim});
		...
		{if $fields.sale_type_advanced.acl > 0}
		{counter assign=index}
	{math equation="left % right"
   		  left=$index
          right=$templateMeta.maxColumns
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='sale_type_advanced'>{sugar_translate label='LBL_SALE_TYPE' module='J_Payment'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='sale_type_advanced' name='sale_type_advanced[]' options=$fields.sale_type_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.sale_type_advanced.value}
   	   	</td>
					{/if}
		...
		{if $fields.payment_amount_advanced.acl > 0}
		{counter assign=index}
	{math equation="left % right"
   		  left=$index
          right=$templateMeta.maxColumns
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='payment_amount_advanced'>{sugar_translate label='LBL_PAYMENT_AMOUNT' module='J_Payment'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{if strlen($fields.payment_amount_advanced.value) <= 0}
{assign var="value" value=$fields.payment_amount_advanced.default_value }
{else}
{assign var="value" value=$fields.payment_amount_advanced.value }
{/if}

{assign var="id" value=$fields.payment_amount_advanced.name }

{if isset($smarty.request.payment_amount_advanced_range_choice)}
{assign var="starting_choice" value=$smarty.request.payment_amount_advanced_range_choice}
{else}
{assign var="starting_choice" value="="}
{/if}
...
{html_options options=$fields.payment_amount_advanced.options selected=$starting_choice}
</select>
...
<input type='text' name='range_{$id}' id='range_{$id}' style='width:75px !important;' size='20' 
    ...
    value='{if empty($smarty.request.range_payment_amount_advanced) && !empty($smarty.request.payment_amount_advanced)}{$smarty.request.payment_amount_advanced}{else}{$smarty.request.range_payment_amount_advanced}{/if}' tabindex='' >
</div>
<div id="{$id}_between_range_div" style="{if $starting_choice=='between'}display:'';{else}display:none;{/if}">
<input type='text' name='start_range_{$id}' 
    id='start_range_{$id}' style='width:75px !important;' size='10' 
     
    value='{$smarty.request.start_range_payment_amount_advanced }' tabindex=''>
{$APP.LBL_AND}
<input type='text' name='end_range_{$id}' 
    id='end_range_{$id}' style='width:75px !important;' size='10' 
     
    value='{$smarty.request.end_range_payment_amount_advanced }' tabindex=''>    
</div> 
</span>
   	   	</td>
					{/if}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='J_Payment'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{html_options id='assigned_user_id_advanced' name='assigned_user_id_advanced[]' options=$fields.assigned_user_id_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.assigned_user_id_advanced.value}
		...
		{if $fields.remain_amount_advanced.acl > 0}
		{counter assign=index}
	{math equation="left % right"
   		  left=$index
          right=$templateMeta.maxColumns
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='remain_amount_advanced'>{sugar_translate label='LBL_REMAIN_AMOUNT' module='J_Payment'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{if strlen($fields.remain_amount_advanced.value) <= 0}
{assign var="value" value=$fields.remain_amount_advanced.default_value }
{else}
{assign var="value" value=$fields.remain_amount_advanced.value }
{/if}

{assign var="id" value=$fields.remain_amount_advanced.name }

{if isset($smarty.request.remain_amount_advanced_range_choice)}
{assign var="starting_choice" value=$smarty.request.remain_amount_advanced_range_choice}
{else}
{assign var="starting_choice" value="="}
{/if}
...
<span style="white-space:nowrap !important;">
<select id="{$id}_range_choice" name="{$id}_range_choice" style="width:190px !important;" onchange="{$id}_range_change(this.value);">
{html_options options=$fields.remain_amount_advanced.options selected=$starting_choice}
</select>
<div id="{$id}_range_div" style="{if $starting_choice=='between'}display:none;{else}display:'';{/if}">
<input type='text' name='range_{$id}' id='range_{$id}' style='width:75px !important;' size='20' 
     
    value='{if empty($smarty.request.range_remain_amount_advanced) && !empty($smarty.request.remain_amount_advanced)}{$smarty.request.remain_amount_advanced}{else}{$smarty.request.range_remain_amount_advanced}{/if}' tabindex='' >
</div>
<div id="{$id}_between_range_div" style="{if $starting_choice=='between'}display:'';{else}display:none;{/if}">
<input type='text' name='start_range_{$id}' 
    id='start_range_{$id}' style='width:75px !important;' size='10' 
     
    value='{$smarty.request.start_range_remain_amount_advanced }' tabindex=''>
{$APP.LBL_AND}
<input type='text' name='end_range_{$id}' 
    id='end_range_{$id}' style='width:75px !important;' size='10' 
     
    value='{$smarty.request.end_range_remain_amount_advanced }' tabindex=''>    
</div> 
</span>
   	   	</td>
					{/if}
		...
		{if $fields.remain_hours_advanced.acl > 0}
		{counter assign=index}
	{math equation="left % right"
   		  left=$index
          right=$templateMeta.maxColumns
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='remain_hours_advanced'>{sugar_translate label='LBL_REMAIN_HOURS' module='J_Payment'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{if strlen($fields.remain_hours_advanced.value) <= 0}
{assign var="value" value=$fields.remain_hours_advanced.default_value }
{else}
{assign var="value" value=$fields.remain_hours_advanced.value }
{/if}

{assign var="id" value=$fields.remain_hours_advanced.name }

{if isset($smarty.request.remain_hours_advanced_range_choice)}
{assign var="starting_choice" value=$smarty.request.remain_hours_advanced_range_choice}
{else}
{assign var="starting_choice" value="="}
{/if}
...
<span style="white-space:nowrap !important;">
<select id="{$id}_range_choice" name="{$id}_range_choice" style="width:190px !important;" onchange="{$id}_range_change(this.value);">
{html_options options=$fields.remain_hours_advanced.options selected=$starting_choice}
</select>
<div id="{$id}_range_div" style="{if $starting_choice=='between'}display:none;{else}display:'';{/if}">
<input type='text' name='range_{$id}' id='range_{$id}' style='width:75px !important;' size='20' 
     
    value='{if empty($smarty.request.range_remain_hours_advanced) && !empty($smarty.request.remain_hours_advanced)}{$smarty.request.remain_hours_advanced}{else}{$smarty.request.range_remain_hours_advanced}{/if}' tabindex='' >
</div>
<div id="{$id}_between_range_div" style="{if $starting_choice=='between'}display:'';{else}display:none;{/if}">
<input type='text' name='start_range_{$id}' 
    id='start_range_{$id}' style='width:75px !important;' size='10' 
     
    value='{$smarty.request.start_range_remain_hours_advanced }' tabindex=''>
{$APP.LBL_AND}
<input type='text' name='end_range_{$id}' 
    id='end_range_{$id}' style='width:75px !important;' size='10' 
     
    value='{$smarty.request.end_range_remain_hours_advanced }' tabindex=''>    
</div> 
</span>
   	   	</td>
					{/if}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='team_name_advanced'>{sugar_translate label='LBL_TEAMS' module='J_Payment'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{sugarvar_teamset parentFieldArray=fields vardef=$fields.team_name tabindex='' display='' labelSpan='' fieldSpan='' formName='search_form' tabindex=1 displayType='renderSearchView'  	 }
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='current_user_only_advanced'>{sugar_translate label='LBL_CURRENT_USER_FILTER' module='J_Payment'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
value="1" title='' tabindex="" {$checked} >
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='favorites_only_advanced'>{sugar_translate label='LBL_FAVORITES_FILTER' module='J_Payment'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
