...
<tr>
		...
		{if $fields.full_lead_name_basic.acl > 0}
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='full_lead_name_basic' >{sugar_translate label='LBL_FULL_NAME' module='Leads'}</label>
    	</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{if strlen($fields.full_lead_name_basic.value) <= 0}
{assign var="value" value=$fields.full_lead_name_basic.default_value }
{else}
{assign var="value" value=$fields.full_lead_name_basic.value }
{/if}  
<input type='text' name='{$fields.full_lead_name_basic.name}' 
    id='{$fields.full_lead_name_basic.name}' size='30' 
    maxlength='250' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='phone_basic' >{sugar_translate label='LBL_ANY_PHONE' module='Leads'}</label>
    	</td>
...
<input type='text' name='{$fields.phone_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='status_basic'> {sugar_translate label='LBL_STATUS' module='Leads'}
		</td>
...
{html_options id='status_basic' name='status_basic[]' options=$fields.status_basic.options size="6" style="width: 150px" multiple="1" selected=$fields.status_basic.value}
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='assigned_user_id_basic' >{sugar_translate label='LBL_ASSIGNED_TO' module='Leads'}</label>
    	</td>
