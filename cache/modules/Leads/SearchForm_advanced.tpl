...
<tr>
		...
		{if $fields.full_lead_name_advanced.acl > 0}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='full_lead_name_advanced'>{sugar_translate label='LBL_FULL_NAME' module='Leads'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{if strlen($fields.full_lead_name_advanced.value) <= 0}
{assign var="value" value=$fields.full_lead_name_advanced.default_value }
{else}
{assign var="value" value=$fields.full_lead_name_advanced.value }
{/if}  
<input type='text' name='{$fields.full_lead_name_advanced.name}' 
    id='{$fields.full_lead_name_advanced.name}' size='30' 
    maxlength='250' 
...
<input type='text' name='{$fields.phone_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='birthdate_advanced'>{sugar_translate label='LBL_BIRTHDATE' module='Leads'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{html_options id='status_advanced' name='status_advanced[]' options=$fields.status_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.status_advanced.value}
		...
		{if $fields.potential_advanced.acl > 0}
		{counter assign=index}
	{math equation="left % right"
   		  left=$index
          right=$templateMeta.maxColumns
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='potential_advanced'>{sugar_translate label='LBL_POTENTIAL' module='Leads'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='potential_advanced' name='potential_advanced[]' options=$fields.potential_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.potential_advanced.value}
   	   	</td>
					{/if}
...
{rdelim});
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='team_name_advanced'>{sugar_translate label='LBL_TEAMS' module='Leads'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<input type='text' name='{$fields.email_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='current_user_only_advanced'>{sugar_translate label='LBL_CURRENT_USER_FILTER' module='Leads'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
