...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> {sugar_translate label='LBL_CONTRACT_NAME' module='Contracts'}
		</td>
...
<input type='text' name='{$fields.name_basic.name}' 
    ...
    value='{$value}' title=''      accesskey='9'  >
		...
		{if $fields.contract_id_basic.acl > 0}
		{counter assign=index}
	{math equation="left % right"
   		  left=$index
          right=$basicMaxColumns
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='contract_id_basic' >{sugar_translate label='LBL_CONTRACT_ID' module='Contracts'}</label>
    	</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{if strlen($fields.contract_id_basic.value) <= 0}
{assign var="value" value=$fields.contract_id_basic.default_value }
{else}
{assign var="value" value=$fields.contract_id_basic.value }
{/if}  
<input type='text' name='{$fields.contract_id_basic.name}' 
    id='{$fields.contract_id_basic.name}' size='30' 
    maxlength='100' 
    value='{$value}' title=''      >
   						{/if}
		   	</td>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='team_name_basic' >{sugar_translate label='LBL_TEAM' module='Contracts'}</label>
    	</td>
