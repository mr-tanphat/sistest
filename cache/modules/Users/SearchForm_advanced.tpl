...
<select id="{$fields.is_admin_advanced.name}" name="{$fields.is_admin_advanced.name}"   >
 ...
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
		...
		{if $fields.for_portal_only_advanced.acl > 0}
		{counter assign=index}
	{math equation="left % right"
   		  left=$index
          right=$templateMeta.maxColumns
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='for_portal_only_advanced'>{sugar_translate label='LBL_FOR_PORTAL_ONLY' module='Users'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{if strval($fields.for_portal_only_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.for_portal_only_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.for_portal_only_advanced.name}" name="{$fields.for_portal_only_advanced.name}"   >
 <option value="" {$default}></option>
 <option value = "0" {$no}> {$APP.LBL_SEARCH_DROPDOWN_NO}</option>
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
</select>
...
<input type='text' name='{$fields.title_advanced.name}' 
    ...
    value='{$value}' title=''      >
		...
		{if $fields.is_template_advanced.acl > 0}
		{counter assign=index}
	{math equation="left % right"
   		  left=$index
          right=$templateMeta.maxColumns
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='is_template_advanced'>{sugar_translate label='LBL_IS_TEMPLATE' module='Users'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{if strval($fields.is_template_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.is_template_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.is_template_advanced.name}" name="{$fields.is_template_advanced.name}"   >
 <option value="" {$default}></option>
 <option value = "0" {$no}> {$APP.LBL_SEARCH_DROPDOWN_NO}</option>
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
</select>
