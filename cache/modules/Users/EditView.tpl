...
{counter name="panelFieldCount"}
{include file="custom/modules/Users/tpls/AvatarEdit.tpl"}
{else}
</td>
<td></td><td></td>
</td>		
...
<td></td><td></td>
{/if}
{if $fields.sign.acl > 1 || ($showDetailData && $fields.sign.acl > 0)}
<td valign="top" id='sign_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_PICTURE_SIGN_FILE' module='Users'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}

<td valign="top" width='37.5%' >
{if $fields.sign.acl > 1}
{counter name="panelFieldCount"}


{if !empty($fields.sign.value) }
...
<input type="hidden" name="{$fields.sign.name}" id="{$fields.sign.name}" value="{$fields.sign.value}">
<span id="{$fields.sign.name}_old" style="display:{if !$showRemove}none;{/if}">
<img src="custom/include/surveylogo_images/{$fields.sign.value}" height="100px" class="tabDetailViewDFLink">
{if !$noChange}
<input type='button' class='button' id='remove_button' value='{$APP.LBL_REMOVE}' onclick='SUGAR.field.file.deleteAttachment("{$fields.sign.name}","",this);'>
{/if}
</span>
{if !$noChange}
<span id="{$fields.sign.name}_new" class="survey-logo-selection" style="display:{if $showRemove}none;{/if}">
<input type="hidden" name="{$fields.sign.name}_escaped">
<input id="{$fields.sign.name}_file" name="{$fields.sign.name}_file" 
...
<span class="sugar_field" id="{$fields.sign.name}">
<a href="index.php?entryPoint=download&id={$fields.id.value}&type={$module}" class="tabDetailViewDFLink" target='_blank'>{$fields.sign.value}</a>
</span>
{/if}
{else}
<td></td><td></td>
...
title=''       
>
{if isset($fields.employee_status.value) && $fields.employee_status.value != ''}
{html_options options=$fields.employee_status.options selected=$fields.employee_status.value}
{else}
{html_options options=$fields.employee_status.options selected=$fields.employee_status.default}
{/if}
</select>
{else}
...
addToValidate('EditView', 'full_user_name', 'varchar', false,'{/literal}{sugar_translate label='LBL_FULL_NAME' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'is_admin', 'bool', false,'{/literal}{sugar_translate label='LBL_IS_ADMIN' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'portal_user', 'bool', false,'{/literal}{sugar_translate label='LBL_PORTAL_USER_P' module='Users' for_js=true}{literal}' );
...
addToValidate('EditView', 'aims_id', 'varchar', false,'{/literal}{sugar_translate label='LBL_AIMS_ID' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'lock_homepage', 'enum', false,'{/literal}{sugar_translate label='LBL_LOCK_HOMEPAGE' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'default_homepage', 'enum', false,'{/literal}{sugar_translate label='LBL_DEFAULT_HOMEPAGE' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'toggle', 'bool', false,'{/literal}{sugar_translate label='LBL_TOGGLE' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'only_once', 'bool', false,'{/literal}{sugar_translate label='LBL_ONLY_ONCE' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'gender', 'enum', false,'{/literal}{sugar_translate label='LBL_GENDER' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'is_notify_new_task', 'bool', false,'{/literal}{sugar_translate label='LBL_IS_NOTIFY_NEW_TASK' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'is_notify_pending_task', 'bool', false,'{/literal}{sugar_translate label='LBL_IS_NOTIFY_PENDING_TASK' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'is_notify_customer_birthday', 'bool', false,'{/literal}{sugar_translate label='LBL_IS_NOTIFY_CUSTOMER_BIRTHDAY' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'numofday_notify_customer_birthday', 'int', false,'{/literal}{sugar_translate label='LBL_NUMOFDAY_NOTIFY_CUSTOMER_BIRTHDAY' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'numofday_before_notify_pending_task', 'int', false,'{/literal}{sugar_translate label='LBL_NUMOFDAY_BEFORE_NOTIFY_PENDING_TASK' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'dob_day', 'enum', false,'{/literal}{sugar_translate label='LBL_DAY' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'dob_month', 'enum', false,'{/literal}{sugar_translate label='LBL_MONTH' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'dob_year', 'int', false,'{/literal}{sugar_translate label='LBL_YEAR' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'dob_date', 'date', false,'{/literal}{sugar_translate label='LBL_BIRTHDATE' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'leaving_request_confirmer[]', 'multienum', false,'{/literal}{sugar_translate label='LBL_LEAVE_CONFIRMER' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'worklog_reminder_recipient[]', 'multienum', false,'{/literal}{sugar_translate label='LBL_WORKLOG_RECIPIENT' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'for_portal_only', 'bool', false,'{/literal}{sugar_translate label='LBL_FOR_PORTAL_ONLY' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'portal_contact_id', 'varchar', false,'{/literal}{sugar_translate label='LBL_PORTAL_CONTACT_ID' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'sign', 'image', false,'{/literal}{sugar_translate label='LBL_PICTURE_SIGN_FILE' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'is_template', 'bool', false,'{/literal}{sugar_translate label='LBL_IS_TEMPLATE' module='Users' for_js=true}{literal}' );
