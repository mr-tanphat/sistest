...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> {sugar_translate label='LBL_NAME' module='C_Carryforward'}
		</td>
...
<input type='text' name='{$fields.name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='type_basic' >{sugar_translate label='LBL_TYPE' module='C_Carryforward'}</label>
    	</td>
...
{html_options id='type_basic' name='type_basic[]' options=$fields.type_basic.options size="6" style="width: 150px" multiple="1" selected=$fields.type_basic.value}
		...
		{if $fields.payment_id_basic.acl > 0}
		{counter assign=index}
	{math equation="left % right"
   		  left=$index
          right=$basicMaxColumns
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='payment_id_basic' >{sugar_translate label='LBL_PAYMENT_ID' module='C_Carryforward'}</label>
    	</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{if strlen($fields.payment_id_basic.value) <= 0}
{assign var="value" value=$fields.payment_id_basic.default_value }
{else}
{assign var="value" value=$fields.payment_id_basic.value }
{/if}  
<input type='text' name='{$fields.payment_id_basic.name}' 
    id='{$fields.payment_id_basic.name}' size='30' 
