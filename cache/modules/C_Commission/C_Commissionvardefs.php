<?php 
 $GLOBALS["dictionary"]["C_Commission"]=array (
  'table' => 'c_commission',
  'audited' => false,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'c_commission_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'c_commission_modified_user',
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'c_commission_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'c_commission_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'c_commission_teams',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'c_commission_assigned_user',
  ...
  array (
    ...
    'team_set_c_commission' => 
    array (
      'name' => 'idx_c_commission_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
