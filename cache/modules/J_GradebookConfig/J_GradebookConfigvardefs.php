<?php 
 $GLOBALS["dictionary"]["J_GradebookConfig"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'j_gradebookconfig_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'j_gradebookconfig_modified_user',
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'j_gradebookconfig_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'j_gradebookconfig_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'j_gradebookconfig_teams',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'j_gradebookconfig_assigned_user',
  ...
  array (
    ...
    'team_set_j_gradebookconfig' => 
    array (
      'name' => 'idx_j_gradebookconfig_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
