<?php 
 $GLOBALS["dictionary"]["C_Timesheet"]=array (
  'table' => 'c_timesheet',
  'audited' => false,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'c_timesheet_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'c_timesheet_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'c_timesheet_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'c_timesheet_teams',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'c_timesheet_assigned_user',
  ...
  array (
    ...
    'team_set_c_timesheet' => 
    array (
      'name' => 'idx_c_timesheet_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
