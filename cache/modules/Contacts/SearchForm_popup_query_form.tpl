...
<input type='text' name='{$fields.contact_id_advanced.name}' 
    ...
    value='{$value}' title=''      accesskey='9'  >
		...
		{if $fields.assistant_advanced.acl > 0}
		{counter assign=index}
	{math equation="left % right"
   		  left=$index
          right=$templateMeta.maxColumns
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='assistant_advanced'>{sugar_translate label='LBL_FULL_NAME' module='Contacts'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
<input type='text' name='{$fields.assistant_advanced.name}' 
    ...
    value='{$value}' title=''      >
		...
		{if $fields.phone_mobile_advanced.acl > 0}
		{counter assign=index}
	{math equation="left % right"
   		  left=$index
          right=$templateMeta.maxColumns
...
<input class="date_input" autocomplete="off" type="text" name="{$fields.birthdate_advanced.name}" id="{$fields.birthdate_advanced.name}" value="{$date_value}" title=''  tabindex=''    size="11" maxlength="10" >
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$fields.birthdate_advanced.name}_trigger"{/capture}
...
{sugarvar_teamset parentFieldArray=fields vardef=$fields.team_name tabindex='' display='' labelSpan='' fieldSpan='' formName='popup_query_form' tabindex=1 displayType='renderSearchView'  	 }
   	   	</td>
					{/if}
			</tr>
<tr>
