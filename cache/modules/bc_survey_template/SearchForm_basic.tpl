...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> {sugar_translate label='LBL_NAME' module='bc_survey_template'}
		</td>
...
<input type='text' name='{$fields.name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='assigned_user_id_basic' >{sugar_translate label='LBL_ASSIGNED_TO' module='bc_survey_template'}</label>
    	</td>
...
{html_options id='assigned_user_id_basic' name='assigned_user_id_basic[]' options=$fields.assigned_user_id_basic.options size="6" style="width: 150px" multiple="1" selected=$fields.assigned_user_id_basic.value}
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='current_user_only_basic' >{sugar_translate label='LBL_CURRENT_USER_FILTER' module='bc_survey_template'}</label>
    	</td>
