<?php /* Smarty version 2.6.11, created on 2017-02-07 13:21:20
         compiled from cache/modules/C_Classes/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/C_Classes/SearchForm_basic.tpl', 33, false),array('function', 'math', 'cache/modules/C_Classes/SearchForm_basic.tpl', 34, false),array('function', 'sugar_translate', 'cache/modules/C_Classes/SearchForm_basic.tpl', 43, false),array('function', 'html_options', 'cache/modules/C_Classes/SearchForm_basic.tpl', 81, false),array('function', 'sugar_getimage', 'cache/modules/C_Classes/SearchForm_basic.tpl', 122, false),array('function', 'sugar_getimagepath', 'cache/modules/C_Classes/SearchForm_basic.tpl', 391, false),array('modifier', 'default', 'cache/modules/C_Classes/SearchForm_basic.tpl', 130, false),array('modifier', 'escape', 'cache/modules/C_Classes/SearchForm_basic.tpl', 143, false),array('modifier', 'count', 'cache/modules/C_Classes/SearchForm_basic.tpl', 378, false),)), $this); ?>
...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> <?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'C_Classes'), $this);?>
...
' title=''      accesskey='9'  >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='type_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'C_Classes'), $this);?>
</label>
    	</td>
...
<?php echo smarty_function_html_options(array('id' => 'type_basic','name' => 'type_basic[]','options' => $this->_tpl_vars['fields']['type_basic']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['type_basic']['value']), $this);?>
		...
		<?php if ($this->_tpl_vars['fields']['start_date_basic']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='start_date_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_START_DATE','module' => 'C_Classes'), $this);?>
</label>
    	</td>
...
<?php $this->assign('id', $this->_tpl_vars['fields']['start_date_basic']['name']); ?>

<?php if (isset ( $_REQUEST['start_date_basic_range_choice'] )): ?>
<?php $this->assign('starting_choice', $_REQUEST['start_date_basic_range_choice']); ?>
<?php else: ?>
...
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['start_date_basic']['options'],'selected' => $this->_tpl_vars['starting_choice']), $this);?>

</select>
</div>

<div id="<?php echo $this->_tpl_vars['id']; ?>
_range_div" style="<?php if (preg_match ( '/^\[/' , $_REQUEST['range_start_date_basic'] ) || $this->_tpl_vars['starting_choice'] == 'between'): ?>display:none<?php else: ?>display:''<?php endif; ?>;">
<input autocomplete="off" type="text" name="range_<?php echo $this->_tpl_vars['id']; ?>
" id="range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php if (empty ( $_REQUEST['range_start_date_basic'] ) && ! empty ( $_REQUEST['start_date_basic'] )):  echo $_REQUEST['start_date_basic'];  else:  echo $_REQUEST['range_start_date_basic'];  endif; ?>' title=''   size="11" style="width:100px !important;">
...
<?php $this->assign('date_value', $this->_tpl_vars['fields']['start_date_basic']['value']); ?>
<input autocomplete="off" type="text" name="start_range_<?php echo $this->_tpl_vars['id']; ?>
" id="start_range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php echo $_REQUEST['start_range_start_date_basic']; ?>
...
" value='<?php echo $_REQUEST['end_range_start_date_basic']; ?>
...
_range_reset);
		...
		<?php if ($this->_tpl_vars['fields']['end_date_basic']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='end_date_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_END_DATE','module' => 'C_Classes'), $this);?>
</label>
    	</td>
...
<?php $this->assign('id', $this->_tpl_vars['fields']['end_date_basic']['name']); ?>

<?php if (isset ( $_REQUEST['end_date_basic_range_choice'] )): ?>
<?php $this->assign('starting_choice', $_REQUEST['end_date_basic_range_choice']); ?>
<?php else: ?>
<?php $this->assign('starting_choice', "="); ?>
<?php endif; ?>
...
_range_choice" style="width:125px !important;" onchange="<?php echo $this->_tpl_vars['id']; ?>
_range_change(this.value);">
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['end_date_basic']['options'],'selected' => $this->_tpl_vars['starting_choice']), $this);?>

</select>
</div>

<div id="<?php echo $this->_tpl_vars['id']; ?>
_range_div" style="<?php if (preg_match ( '/^\[/' , $_REQUEST['range_end_date_basic'] ) || $this->_tpl_vars['starting_choice'] == 'between'): ?>display:none<?php else: ?>display:''<?php endif; ?>;">
<input autocomplete="off" type="text" name="range_<?php echo $this->_tpl_vars['id']; ?>
" id="range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php if (empty ( $_REQUEST['range_end_date_basic'] ) && ! empty ( $_REQUEST['end_date_basic'] )):  echo $_REQUEST['end_date_basic'];  else:  echo $_REQUEST['range_end_date_basic'];  endif; ?>' title=''   size="11" style="width:100px !important;">
<?php ob_start(); ?>alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
" style="position:relative; top:6px" border="0" id="<?php echo $this->_tpl_vars['id']; ?>
_trigger"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('other_attributes', ob_get_contents());ob_end_clean(); ?>
<?php echo smarty_function_sugar_getimage(array('name' => 'jscalendar','ext' => ".gif",'other_attributes' => ($this->_tpl_vars['other_attributes'])), $this);?>
...
<div id="<?php echo $this->_tpl_vars['id']; ?>
_between_range_div" style="<?php if ($this->_tpl_vars['starting_choice'] == 'between'): ?>display:'';<?php else: ?>display:none;<?php endif; ?>">
<?php $this->assign('date_value', $this->_tpl_vars['fields']['end_date_basic']['value']); ?>
<input autocomplete="off" type="text" name="start_range_<?php echo $this->_tpl_vars['id']; ?>
" id="start_range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php echo $_REQUEST['start_range_end_date_basic']; ?>
' title=''  tabindex='' size="11" style="width:100px !important;">
<?php ob_start(); ?>align="absmiddle" border="0" id="start_range_<?php echo $this->_tpl_vars['id']; ?>
_trigger"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('other_attributes', ob_get_contents());ob_end_clean(); ?>
<?php echo smarty_function_sugar_getimage(array('name' => 'jscalendar','ext' => ".gif",'alt' => ((is_array($_tmp=$this->_tpl_vars['APP']['LBL_ENTER_DATE'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')),'other_attributes' => $this->_tpl_vars['other_attributes']), $this);?>
...
<input autocomplete="off" type="text" name="end_range_<?php echo $this->_tpl_vars['id']; ?>
" id="end_range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php echo $_REQUEST['end_range_end_date_basic']; ?>
' title=''  tabindex='' size="11" style="width:100px !important;" maxlength="10">
<?php ob_start(); ?>align="absmiddle" border="0" id="end_range_<?php echo $this->_tpl_vars['id']; ?>
_trigger"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('other_attributes', ob_get_contents());ob_end_clean(); ?>
<?php echo smarty_function_sugar_getimage(array('name' => 'jscalendar','ext' => ".gif",'alt' => ((is_array($_tmp=$this->_tpl_vars['APP']['LBL_ENTER_DATE'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')),'other_attributes' => $this->_tpl_vars['other_attributes']), $this);?>
