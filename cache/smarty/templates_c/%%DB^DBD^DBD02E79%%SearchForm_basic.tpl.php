<?php /* Smarty version 2.6.11, created on 2017-02-07 09:47:16
         compiled from cache/modules/Prospects/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Prospects/SearchForm_basic.tpl', 33, false),array('function', 'math', 'cache/modules/Prospects/SearchForm_basic.tpl', 34, false),array('function', 'sugar_translate', 'cache/modules/Prospects/SearchForm_basic.tpl', 44, false),array('function', 'html_options', 'cache/modules/Prospects/SearchForm_basic.tpl', 114, false),array('function', 'sugar_getimagepath', 'cache/modules/Prospects/SearchForm_basic.tpl', 218, false),array('modifier', 'count', 'cache/modules/Prospects/SearchForm_basic.tpl', 205, false),)), $this); ?>
...
<tr>
		...
		<?php if ($this->_tpl_vars['fields']['full_target_name_basic']['acl'] > 0): ?>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='full_target_name_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_FULL_NAME','module' => 'Prospects'), $this);?>
</label>
    	</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['full_target_name_basic']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['full_target_name_basic']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['full_target_name_basic']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['full_target_name_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['full_target_name_basic']['name']; ?>
' size='30' 
    maxlength='250' 
...
' title=''      accesskey='9'  >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='phone_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_PHONE','module' => 'Prospects'), $this);?>
</label>
    	</td>
...
' title=''      >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='status_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'Prospects'), $this);?>
</label>
    	</td>
...
<?php echo smarty_function_html_options(array('id' => 'status_basic','name' => 'status_basic[]','options' => $this->_tpl_vars['fields']['status_basic']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['status_basic']['value']), $this);?>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='assigned_user_id_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'Prospects'), $this);?>
</label>
    	</td>
...
value="1" title='' tabindex="" <?php echo $this->_tpl_vars['checked']; ?>
 >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='favorites_only_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_FAVORITES_FILTER','module' => 'Prospects'), $this);?>
</label>
    	</td>
