<?php /* Smarty version 2.6.11, created on 2017-02-07 13:39:03
         compiled from custom/modules/J_Payment/tpl/delayPayment.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getscript', 'custom/modules/J_Payment/tpl/delayPayment.tpl', 1, false),)), $this); ?>
<?php echo smarty_function_sugar_getscript(array('file' => "custom/modules/J_Payment/js/dropPayment.js"), $this);?>
...
<div id="drop_payment_dialog" title="Drop Payment" style="display:none;">
        ...
        <span class="dateTime" style="margin-right: 70px;margin-left: 10px;">
            <input disabled name="dl_date" size="10" id="dl_date" type="text" value="<?php echo $this->_tpl_vars['today']; ?>
">
