<?php /* Smarty version 2.6.11, created on 2017-02-07 15:00:50
         compiled from cache/modules/Users/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Users/SearchForm_advanced.tpl', 28, false),array('function', 'math', 'cache/modules/Users/SearchForm_advanced.tpl', 29, false),array('function', 'sugar_getimagepath', 'cache/modules/Users/SearchForm_advanced.tpl', 37, false),array('function', 'sugar_translate', 'cache/modules/Users/SearchForm_advanced.tpl', 46, false),array('function', 'html_options', 'cache/modules/Users/SearchForm_advanced.tpl', 164, false),array('function', 'sugar_getimage', 'cache/modules/Users/SearchForm_advanced.tpl', 717, false),)), $this); ?>
...
> <?php echo $this->_tpl_vars['APP']['LBL_SEARCH_DROPDOWN_YES']; ?>
		...
		<?php if ($this->_tpl_vars['fields']['for_portal_only_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='for_portal_only_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_FOR_PORTAL_ONLY','module' => 'Users'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<?php if (strval ( $this->_tpl_vars['fields']['for_portal_only_advanced']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED'); ?>
<?php elseif (strval ( $this->_tpl_vars['fields']['for_portal_only_advanced']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED'); ?>
<?php else: ?>
	<?php $this->assign('default', 'SELECTED'); ?>
<?php endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['for_portal_only_advanced']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['for_portal_only_advanced']['name']; ?>
"   >
 <option value="" <?php echo $this->_tpl_vars['default']; ?>
></option>
 <option value = "0" <?php echo $this->_tpl_vars['no']; ?>
...
' title=''      >
		...
		<?php if ($this->_tpl_vars['fields']['is_template_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='is_template_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_IS_TEMPLATE','module' => 'Users'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<?php if (strval ( $this->_tpl_vars['fields']['is_template_advanced']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED'); ?>
<?php elseif (strval ( $this->_tpl_vars['fields']['is_template_advanced']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED'); ?>
<?php else: ?>
	<?php $this->assign('default', 'SELECTED'); ?>
<?php endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['is_template_advanced']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['is_template_advanced']['name']; ?>
"   >
 <option value="" <?php echo $this->_tpl_vars['default']; ?>
></option>
 <option value = "0" <?php echo $this->_tpl_vars['no']; ?>
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_team_name_advanced\']={"form":"search_form","method":"query","modules":["Teams"],"group":"or","field_list":["name","id"],"populate_list":["team_name_advanced","team_id_advanced"],"required_list":["team_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""},{"name":"name","op":"like_custom","begin":"(","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_reports_to_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["reports_to_name_advanced","reports_to_id_advanced"],"required_list":["reports_to_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};</script>'; ?>