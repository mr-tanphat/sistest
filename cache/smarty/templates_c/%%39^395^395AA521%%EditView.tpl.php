<?php /* Smarty version 2.6.11, created on 2017-02-08 09:47:25
         compiled from cache/modules/bc_survey_automizer/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/bc_survey_automizer/EditView.tpl', 45, false),array('function', 'counter', 'cache/modules/bc_survey_automizer/EditView.tpl', 51, false),array('function', 'sugar_translate', 'cache/modules/bc_survey_automizer/EditView.tpl', 58, false),array('function', 'sugar_getimagepath', 'cache/modules/bc_survey_automizer/EditView.tpl', 117, false),array('function', 'html_options', 'cache/modules/bc_survey_automizer/EditView.tpl', 160, false),array('modifier', 'strip_semicolon', 'cache/modules/bc_survey_automizer/EditView.tpl', 59, false),array('modifier', 'lookup', 'cache/modules/bc_survey_automizer/EditView.tpl', 185, false),array('modifier', 'count', 'cache/modules/bc_survey_automizer/EditView.tpl', 265, false),array('modifier', 'escape', 'cache/modules/bc_survey_automizer/EditView.tpl', 1120, false),array('modifier', 'url2html', 'cache/modules/bc_survey_automizer/EditView.tpl', 1120, false),array('modifier', 'nl2br', 'cache/modules/bc_survey_automizer/EditView.tpl', 1120, false),)), $this); ?>
...
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_KEY']; ?>
" class="button" onclick="SUGAR.ajaxUI.loadContent('index.php?action=index&module=bc_survey_automizer'); return false;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
...
&module_name=bc_survey_automizer", true, false,  { "call_back_function":"set_return","form_name":"EditView","field_to_name_array":[] } ); return false;' type="button" value="<?php echo $this->_tpl_vars['APP']['LNK_VIEW_CHANGE_LOG']; ?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'bc_survey_automizer'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'bc_survey_automizer'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php ob_start(); ?>
<tr>
<?php if ($this->_tpl_vars['fields']['flow_module']['acl'] > 1 || ( $this->_tpl_vars['showDetailData'] && $this->_tpl_vars['fields']['flow_module']['acl'] > 0 )): ?>
<td valign="top" id='flow_module_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_FLOW_MODULE','module' => 'bc_survey_automizer'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
</td>
...
<td valign="top" width='37.5%' >
<?php if ($this->_tpl_vars['fields']['flow_module']['acl'] > 1): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<?php ob_start();  echo $this->_tpl_vars['fields']['flow_module']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
<?php ob_start();  echo $this->_tpl_vars['fields']['flow_module']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'bc_survey_automizer'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php ob_start(); ?>
<tr>
<?php if ($this->_tpl_vars['fields']['run_when']['acl'] > 1 || ( $this->_tpl_vars['showDetailData'] && $this->_tpl_vars['fields']['run_when']['acl'] > 0 )): ?>
<td valign="top" id='run_when_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_RUN_WHEN','module' => 'bc_survey_automizer'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<td valign="top" width='37.5%' >
<?php if ($this->_tpl_vars['fields']['run_when']['acl'] > 1): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<?php ob_start();  echo $this->_tpl_vars['fields']['run_when']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
<?php ob_start();  echo $this->_tpl_vars['fields']['run_when']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
...
<td></td><td></td>
<?php endif; ?>
<?php if ($this->_tpl_vars['fields']['flow_run_on']['acl'] > 1 || ( $this->_tpl_vars['showDetailData'] && $this->_tpl_vars['fields']['flow_run_on']['acl'] > 0 )): ?>
<td valign="top" id='flow_run_on_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_FLOW_RUN_ON','module' => 'bc_survey_automizer'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
</td>
...
<td valign="top" width='37.5%' >
<?php if ($this->_tpl_vars['fields']['flow_run_on']['acl'] > 1): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<?php ob_start();  echo $this->_tpl_vars['fields']['flow_run_on']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
<?php ob_start();  echo $this->_tpl_vars['fields']['flow_run_on']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'bc_survey_automizer'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<script type="text/javascript">
addForm(\'EditView\');addToValidate(\'EditView\', \'name\', \'name\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'bc_survey_automizer','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'date_entered_date\', \'date\', false,\'Date Created\' );
addToValidate(\'EditView\', \'date_modified_date\', \'date\', false,\'Date Modified\' );
addToValidate(\'EditView\', \'modified_user_id\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'bc_survey_automizer','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'modified_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_NAME','module' => 'bc_survey_automizer','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'bc_survey_automizer','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'bc_survey_automizer','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'description\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'bc_survey_automizer','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'deleted\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DELETED','module' => 'bc_survey_automizer','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_id\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_ID','module' => 'bc_survey_automizer','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'bc_survey_automizer','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'flow_module\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FLOW_MODULE','module' => 'bc_survey_automizer','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'flow_run_on\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_RUN_ON','module' => 'bc_survey_automizer','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'status\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'bc_survey_automizer','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'run_when\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_RUN_WHEN','module' => 'bc_survey_automizer','for_js' => true), $this); echo '\' );
addToValidateBinaryDependency(\'EditView\', \'assigned_user_name\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'bc_survey_automizer','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'bc_survey_automizer','for_js' => true), $this); echo '\', \'assigned_user_id\' );
...
SUGAR.forms.AssignmentHandler.LINKS[\'EditView\'] = {"created_by_link":{"relationship":"bc_survey_automizer_created_by","module":"Users","id_name":"created_by"},"modified_user_link":{"relationship":"bc_survey_automizer_modified_user","module":"Users","id_name":"modified_user_id"},"assigned_user_link":{"relationship":"bc_survey_automizer_assigned_user","module":"Users","id_name":"assigned_user_id"},"bc_survey_automizer_bc_automizer_condition":{"relationship":"bc_survey_automizer_bc_automizer_condition","module":"bc_automizer_condition"},"bc_survey_automizer_bc_automizer_actions":{"relationship":"bc_survey_automizer_bc_automizer_actions","module":"bc_automizer_actions"}}
