...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'cache/modules/Prospects/DetailView.tpl', 7, false),array('modifier', 'strip_semicolon', 'cache/modules/Prospects/DetailView.tpl', 79, false),array('modifier', 'escape', 'cache/modules/Prospects/DetailView.tpl', 373, false),array('modifier', 'url2html', 'cache/modules/Prospects/DetailView.tpl', 373, false),array('modifier', 'nl2br', 'cache/modules/Prospects/DetailView.tpl', 373, false),array('modifier', 'strip_tags', 'cache/modules/Prospects/DetailView.tpl', 383, false),array('function', 'sugar_button', 'cache/modules/Prospects/DetailView.tpl', 46, false),array('function', 'sugar_include', 'cache/modules/Prospects/DetailView.tpl', 53, false),array('function', 'counter', 'cache/modules/Prospects/DetailView.tpl', 58, false),array('function', 'sugar_getimagepath', 'cache/modules/Prospects/DetailView.tpl', 61, false),array('function', 'sugar_translate', 'cache/modules/Prospects/DetailView.tpl', 64, false),array('function', 'sugar_ajax_url', 'cache/modules/Prospects/DetailView.tpl', 177, false),array('function', 'sugar_phone', 'cache/modules/Prospects/DetailView.tpl', 263, false),array('function', 'sugar_getscript', 'cache/modules/Prospects/DetailView.tpl', 369, false),array('function', 'sugarvar_teamset', 'cache/modules/Prospects/DetailView.tpl', 635, false),)), $this); ?>
...
" id="delete_button"><?php endif; ?>  <?php echo $this->_tpl_vars['btn_convert']; ?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'Prospects'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
...
<td>&nbsp;</td><td>&nbsp;</td>
<?php endif; ?>
<?php if ($this->_tpl_vars['fields']['j_school_prospects_1_name']['acl'] > 0): ?>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>

<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['j_school_prospects_1_name']['hidden']): ?>
...
<td>&nbsp;</td><td>&nbsp;</td>
<?php endif; ?>
<?php if ($this->_tpl_vars['fields']['guardian_phone']['acl'] > 0): ?>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>

<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['guardian_phone']['hidden']): ?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS','module' => 'Prospects'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php else: ?>
<?php echo smarty_function_counter(array('name' => 'fieldsHidden'), $this);?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'Prospects'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php else: ?>
<?php echo smarty_function_counter(array('name' => 'fieldsHidden'), $this);?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_MODIFIED','module' => 'Prospects'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php else: ?>
<?php echo smarty_function_counter(array('name' => 'fieldsHidden'), $this);?>
...
SUGAR.util.doWhen("typeof collapsePanel == 'function'",
        function(){
            ...
            if(sugar_panel_collase != null) {
                ...
                for(panel in sugar_panel_collase['Prospects_d'])
                    if(sugar_panel_collase['Prospects_d'][panel])
                        collapsePanel(panel);
                    else
                        expandPanel(panel);
            }
