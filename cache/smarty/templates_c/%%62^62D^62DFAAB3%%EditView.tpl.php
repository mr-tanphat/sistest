<?php /* Smarty version 2.6.11, created on 2017-02-07 10:13:56
         compiled from custom/include/SugarFields/Fields/Image/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'custom/include/SugarFields/Fields/Image/EditView.tpl', 51, false),array('function', 'sugarvar', 'custom/include/SugarFields/Fields/Image/EditView.tpl', 53, false),array('modifier', 'default', 'custom/include/SugarFields/Fields/Image/EditView.tpl', 105, false),)), $this); ?>
{*
/*********************************************************************************
...
_old" style="display:{if !$showRemove}none;{/if}">
  <img src="custom/include/surveylogo_images/<?php echo smarty_function_sugarvar(array('key' => 'value'), $this);?>
...
{if !$noChange}
<span id="<?php echo $this->_tpl_vars['idName']; ?>
_new" class="survey-logo-selection" style="display:{if $showRemove}none;{/if}">
<input type="hidden" name="<?php echo $this->_tpl_vars['idName']; ?>
_escaped">
