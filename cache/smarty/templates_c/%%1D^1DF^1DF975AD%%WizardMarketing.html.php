<?php /* Smarty version 2.6.11, created on 2015-09-22 14:28:33
         compiled from modules/Campaigns/WizardMarketing.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getimagepath', 'modules/Campaigns/WizardMarketing.html', 108, false),array('function', 'sugar_getscript', 'modules/Campaigns/WizardMarketing.html', 358, false),)), $this); ?>
<!--
/*********************************************************************************
...
2'><?php echo $this->_tpl_vars['MOD']['LBL_NAVIGATION_MENU_GEN2']; ?>
                                                ...
                                                <?php if ($this->_tpl_vars['CAMPAIGN_TYPE'] != 'SMS'): ?>
...
' name='wiz_step3_status'><?php echo $this->_tpl_vars['STATUS_OPTIONS']; ?>
        ...
        <tr>
                        <?php if ($this->_tpl_vars['CAMPAIGN_TYPE'] == 'SMS'): ?>
            <td scope="col" NOWRAP valign="top"><slot></slot></td><td ><slot></slot></td>
            <?php else: ?>
