<?php /* Smarty version 2.6.11, created on 2017-02-08 17:13:01
         compiled from cache/modules/J_Class/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/J_Class/SearchForm_advanced.tpl', 28, false),array('function', 'math', 'cache/modules/J_Class/SearchForm_advanced.tpl', 29, false),array('function', 'sugar_getimagepath', 'cache/modules/J_Class/SearchForm_advanced.tpl', 37, false),array('function', 'sugar_translate', 'cache/modules/J_Class/SearchForm_advanced.tpl', 47, false),array('function', 'html_options', 'cache/modules/J_Class/SearchForm_advanced.tpl', 128, false),array('function', 'sugar_getimage', 'cache/modules/J_Class/SearchForm_advanced.tpl', 176, false),array('function', 'sugarvar_teamset', 'cache/modules/J_Class/SearchForm_advanced.tpl', 914, false),array('modifier', 'default', 'cache/modules/J_Class/SearchForm_advanced.tpl', 184, false),array('modifier', 'escape', 'cache/modules/J_Class/SearchForm_advanced.tpl', 197, false),)), $this); ?>
...
<tr>
		...
		<?php if ($this->_tpl_vars['fields']['class_code_advanced']['acl'] > 0): ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='class_code_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CLASS_CODE','module' => 'J_Class'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['class_code_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['class_code_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['class_code_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['class_code_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['class_code_advanced']['name']; ?>
' size='30' 
    maxlength='50' 
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
			<label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'J_Class'), $this);?>
</label>
		</td>
	<td  nowrap="nowrap" width='25%'>
...
' title=''      >
		...
		<?php if ($this->_tpl_vars['fields']['class_type_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='class_type_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CLASS_TYPE','module' => 'J_Class'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('id' => 'class_type_advanced','name' => 'class_type_advanced[]','options' => $this->_tpl_vars['fields']['class_type_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['class_type_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='start_date_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_START_DATE','module' => 'J_Class'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='end_date_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_END_DATE','module' => 'J_Class'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='status_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'J_Class'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<?php echo smarty_function_html_options(array('id' => 'status_advanced','name' => 'status_advanced[]','options' => $this->_tpl_vars['fields']['status_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['status_advanced']['value']), $this);?>
		...
		<?php if ($this->_tpl_vars['fields']['kind_of_course_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='kind_of_course_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_KIND_OF_COURSE','module' => 'J_Class'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('id' => 'kind_of_course_advanced','name' => 'kind_of_course_advanced[]','options' => $this->_tpl_vars['fields']['kind_of_course_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['kind_of_course_advanced']['value']), $this);?>
		...
		<?php if ($this->_tpl_vars['fields']['hours_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='hours_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_HOURS','module' => 'J_Class'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<?php $this->assign('id', $this->_tpl_vars['fields']['hours_advanced']['name']); ?>

<?php if (isset ( $_REQUEST['hours_advanced_range_choice'] )): ?>
<?php $this->assign('starting_choice', $_REQUEST['hours_advanced_range_choice']); ?>
<?php else: ?>
<?php $this->assign('starting_choice', "="); ?>
<?php endif; ?>
...
_range_change(this.value);">
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['hours_advanced']['options'],'selected' => $this->_tpl_vars['starting_choice']), $this);?>
...
' style='width:75px !important;' size='20' 
    ...
    value='<?php if (empty ( $_REQUEST['range_hours_advanced'] ) && ! empty ( $_REQUEST['hours_advanced'] )):  echo $_REQUEST['hours_advanced'];  else:  echo $_REQUEST['range_hours_advanced'];  endif; ?>' tabindex='' >
</div>
<div id="<?php echo $this->_tpl_vars['id']; ?>
_between_range_div" style="<?php if ($this->_tpl_vars['starting_choice'] == 'between'): ?>display:'';<?php else: ?>display:none;<?php endif; ?>">
...
' style='width:75px !important;' size='10' 
    ...
    value='<?php echo $_REQUEST['start_range_hours_advanced']; ?>
' tabindex=''>
<?php echo $this->_tpl_vars['APP']['LBL_AND']; ?>
...
' style='width:75px !important;' size='10' 
    ...
    value='<?php echo $_REQUEST['end_range_hours_advanced']; ?>
' tabindex=''>    
</div> 
</span>
   	   	</td>
		...
		<?php if ($this->_tpl_vars['fields']['max_size_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='max_size_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_MAX_SIZE','module' => 'J_Class'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('id' => 'max_size_advanced','name' => 'max_size_advanced[]','options' => $this->_tpl_vars['fields']['max_size_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['max_size_advanced']['value']), $this);?>
		...
		<?php if ($this->_tpl_vars['fields']['isupgrade_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='isupgrade_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ISUPGRADE','module' => 'J_Class'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<?php if (strval ( $this->_tpl_vars['fields']['isupgrade_advanced']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED'); ?>
<?php elseif (strval ( $this->_tpl_vars['fields']['isupgrade_advanced']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED'); ?>
<?php else: ?>
	<?php $this->assign('default', 'SELECTED'); ?>
<?php endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['isupgrade_advanced']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['isupgrade_advanced']['name']; ?>
"   >
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='level_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_LEVEL','module' => 'J_Class'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<?php echo smarty_function_html_options(array('id' => 'level_advanced','name' => 'level_advanced[]','options' => $this->_tpl_vars['fields']['level_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['level_advanced']['value']), $this);?>
		...
		<?php if ($this->_tpl_vars['fields']['modules_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='modules_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_MODULE','module' => 'J_Class'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('id' => 'modules_advanced','name' => 'modules_advanced[]','options' => $this->_tpl_vars['fields']['modules_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['modules_advanced']['value']), $this);?>
		...
		<?php if ($this->_tpl_vars['fields']['period_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='period_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PERIOD','module' => 'J_Class'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('id' => 'period_advanced','name' => 'period_advanced[]','options' => $this->_tpl_vars['fields']['period_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['period_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='assigned_user_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'J_Class'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='current_user_only_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENT_USER_FILTER','module' => 'J_Class'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='favorites_only_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_FAVORITES_FILTER','module' => 'J_Class'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='team_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TEAMS','module' => 'J_Class'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<?php echo smarty_function_sugarvar_teamset(array('parentFieldArray' => 'fields','vardef' => $this->_tpl_vars['fields']['team_name'],'tabindex' => 1,'display' => '','labelSpan' => '','fieldSpan' => '','formName' => 'search_form','displayType' => 'renderSearchView'), $this);?>
		...
		<?php if ($this->_tpl_vars['fields']['description_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='description_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'J_Class'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
