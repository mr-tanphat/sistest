<?php /* Smarty version 2.6.11, created on 2017-02-07 09:35:59
         compiled from cache/modules/J_School/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/J_School/SearchForm_popup_query_form.tpl', 28, false),array('function', 'math', 'cache/modules/J_School/SearchForm_popup_query_form.tpl', 29, false),array('function', 'sugar_getimagepath', 'cache/modules/J_School/SearchForm_popup_query_form.tpl', 37, false),array('function', 'sugar_translate', 'cache/modules/J_School/SearchForm_popup_query_form.tpl', 47, false),array('function', 'html_options', 'cache/modules/J_School/SearchForm_popup_query_form.tpl', 90, false),array('function', 'sugar_getimage', 'cache/modules/J_School/SearchForm_popup_query_form.tpl', 221, false),)), $this); ?>
...
<tr>
		...
		<?php if ($this->_tpl_vars['fields']['short_name_advanced']['acl'] > 0): ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='short_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SHORT_NAME','module' => 'J_School'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['short_name_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['short_name_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['short_name_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['short_name_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['short_name_advanced']['name']; ?>
' size='30' 
    maxlength='150' 
...
' title=''      accesskey='9'  >
		...
		<?php if ($this->_tpl_vars['fields']['level_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='level_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_LEVEL','module' => 'J_School'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php echo smarty_function_html_options(array('id' => 'level_advanced','name' => 'level_advanced[]','options' => $this->_tpl_vars['fields']['level_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['level_advanced']['value']), $this);?>
		...
		<?php if ($this->_tpl_vars['fields']['address_address_street_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='address_address_street_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ADDRESS_STREET','module' => 'J_School'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['address_address_street_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['address_address_street_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['address_address_street_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['address_address_street_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['address_address_street_advanced']['name']; ?>
' size='30' 
    maxlength='100' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
		...
		<?php if ($this->_tpl_vars['fields']['address_address_state_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='address_address_state_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ADDRESS_STATE','module' => 'J_School'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['address_address_state_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['address_address_state_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['address_address_state_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['address_address_state_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['address_address_state_advanced']['name']; ?>
' size='30' 
    maxlength='100' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
		...
		<?php if ($this->_tpl_vars['fields']['address_address_city_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='address_address_city_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ADDRESS_CITY','module' => 'J_School'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['address_address_city_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['address_address_city_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['address_address_city_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['address_address_city_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['address_address_city_advanced']['name']; ?>
' size='30' 
    maxlength='100' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
