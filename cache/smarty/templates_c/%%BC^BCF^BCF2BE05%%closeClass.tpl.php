<?php /* Smarty version 2.6.11, created on 2017-02-07 13:25:48
         compiled from custom/modules/J_Class/tpls/closeClass.tpl */ ?>
<div id="diaglog_close_class" title="Are you sure you want to Submit Close this class ?" style="display:none;">
    <table width="100%"  class="edit view">
        <tbody>
            <tr>
                <td width="40%"><?php echo $this->_tpl_vars['MOD']['LBL_CLOSED_DATE']; ?>
:<span style="color:red;">*</span></td>
                <td width="60%">
                <span class="dateTime">
                <input disabled name="cc_closed_date" size="10" id="cc_closed_date" type="text" value="<?php echo $this->_tpl_vars['fields']['closed_date']['value']; ?>
">  <img border="0" src="custom/themes/default/images/jscalendar.png" alt="Enter Date" id="cc_closed_date_trigger" align="absmiddle"></span>
                </td>
            </tr>
            <tr>
            <td colspan="2;">
