<?php /* Smarty version 2.6.11, created on 2017-02-08 16:50:11
         compiled from cache/modules/J_Gradebook/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/J_Gradebook/SearchForm_basic.tpl', 33, false),array('function', 'math', 'cache/modules/J_Gradebook/SearchForm_basic.tpl', 34, false),array('function', 'sugar_translate', 'cache/modules/J_Gradebook/SearchForm_basic.tpl', 43, false),array('function', 'sugar_getimage', 'cache/modules/J_Gradebook/SearchForm_basic.tpl', 84, false),array('function', 'sugar_getimagepath', 'cache/modules/J_Gradebook/SearchForm_basic.tpl', 131, false),array('modifier', 'count', 'cache/modules/J_Gradebook/SearchForm_basic.tpl', 118, false),)), $this); ?>
...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> <?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'J_Gradebook'), $this);?>
...
' title=''      accesskey='9'  >
		...
		<?php if ($this->_tpl_vars['fields']['j_class_j_gradebook_1_name_basic']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='j_class_j_gradebook_1_name_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_J_CLASS_J_GRADEBOOK_1_FROM_J_CLASS_TITLE','module' => 'J_Gradebook'), $this);?>
</label>
    	</td>
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['j_class_j_gradebook_1_name_basic']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['j_class_j_gradebook_1_name_basic']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['j_class_j_gradebook_1_name_basic']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['j_class_j_gradebook_1j_class_ida_basic']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['j_class_j_gradebook_1j_class_ida_basic']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['j_class_j_gradebook_1_name_basic']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['j_class_j_gradebook_1_name_basic']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"j_class_j_gradebook_1j_class_ida_basic","name":"j_class_j_gradebook_1_name_basic"}}'; ?>
...
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['j_class_j_gradebook_1_name_basic']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['j_class_j_gradebook_1_name_basic']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['j_class_j_gradebook_1j_class_ida_basic']['name']; ?>
...
"><?php echo smarty_function_sugar_getimage(array('name' => "id-ff-clear",'alt' => $this->_tpl_vars['app_strings']['LBL_ID_FF_CLEAR'],'ext' => ".png",'other_attributes' => ''), $this);?>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='team_name_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TEAM','module' => 'J_Gradebook'), $this);?>
</label>
    	</td>
