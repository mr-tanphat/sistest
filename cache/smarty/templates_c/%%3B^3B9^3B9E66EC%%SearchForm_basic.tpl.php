<?php /* Smarty version 2.6.11, created on 2017-02-07 09:34:03
         compiled from cache/modules/bc_survey/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/bc_survey/SearchForm_basic.tpl', 33, false),array('function', 'math', 'cache/modules/bc_survey/SearchForm_basic.tpl', 34, false),array('function', 'sugar_translate', 'cache/modules/bc_survey/SearchForm_basic.tpl', 43, false),array('function', 'sugar_getimage', 'cache/modules/bc_survey/SearchForm_basic.tpl', 84, false),array('function', 'sugar_getimagepath', 'cache/modules/bc_survey/SearchForm_basic.tpl', 134, false),array('modifier', 'count', 'cache/modules/bc_survey/SearchForm_basic.tpl', 121, false),)), $this); ?>
...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> <?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'bc_survey'), $this);?>
...
' title=''      accesskey='9'  >
		...
		<?php if ($this->_tpl_vars['fields']['bc_survey_bc_survey_template_name_basic']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='bc_survey_bc_survey_template_name_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_BC_SURVEY_BC_SURVEY_TEMPLATE_FROM_BC_SURVEY_TEMPLATE_TITLE','module' => 'bc_survey'), $this);?>
</label>
    	</td>
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['bc_survey_bc_survey_template_name_basic']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['bc_survey_bc_survey_template_name_basic']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['bc_survey_bc_survey_template_name_basic']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['bc_survey_bc_survey_templatebc_survey_template_ida_basic']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['bc_survey_bc_survey_templatebc_survey_template_ida_basic']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['bc_survey_bc_survey_template_name_basic']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['bc_survey_bc_survey_template_name_basic']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"bc_survey_bc_survey_templatebc_survey_template_ida_basic","name":"bc_survey_bc_survey_template_name_basic"}}'; ?>
...
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['bc_survey_bc_survey_template_name_basic']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['bc_survey_bc_survey_template_name_basic']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['bc_survey_bc_survey_templatebc_survey_template_ida_basic']['name']; ?>
...
"><?php echo smarty_function_sugar_getimage(array('name' => "id-ff-clear",'alt' => $this->_tpl_vars['app_strings']['LBL_ID_FF_CLEAR'],'ext' => ".png",'other_attributes' => ''), $this);?>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='current_user_only_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENT_USER_FILTER','module' => 'bc_survey'), $this);?>
</label>
    	</td>
...
</table><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_modified_by_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_basic","modified_user_id_basic"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_created_by_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_basic","created_by_basic"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_assigned_user_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_basic","assigned_user_id_basic"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_bc_survey_bc_survey_template_name_basic\']={"form":"search_form","method":"query","modules":["bc_survey_template"],"group":"or","field_list":["name","id"],"populate_list":["bc_survey_bc_survey_template_name_basic","bc_survey_bc_survey_templatebc_survey_template_ida_basic"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>'; ?>