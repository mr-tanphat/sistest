<?php /* Smarty version 2.6.11, created on 2017-02-07 09:34:07
         compiled from custom/include/EditView/SugarVCR.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getimage', 'custom/include/EditView/SugarVCR.tpl', 70, false),)), $this); ?>
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        <td nowrap class="paginationWrapper">
            <?php if (! empty ( $this->_tpl_vars['list_link'] )): ?>
                <?php if ($this->_tpl_vars['module'] == 'bc_survey_template' || $this->_tpl_vars['module'] == 'bc_survey'): ?>
