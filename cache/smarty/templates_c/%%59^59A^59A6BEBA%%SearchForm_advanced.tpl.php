<?php /* Smarty version 2.6.11, created on 2017-02-08 16:33:14
         compiled from cache/modules/Contacts/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Contacts/SearchForm_advanced.tpl', 28, false),array('function', 'math', 'cache/modules/Contacts/SearchForm_advanced.tpl', 29, false),array('function', 'sugar_getimagepath', 'cache/modules/Contacts/SearchForm_advanced.tpl', 37, false),array('function', 'sugar_translate', 'cache/modules/Contacts/SearchForm_advanced.tpl', 47, false),array('function', 'html_options', 'cache/modules/Contacts/SearchForm_advanced.tpl', 178, false),array('function', 'sugar_getimage', 'cache/modules/Contacts/SearchForm_advanced.tpl', 185, false),array('function', 'sugarvar_teamset', 'cache/modules/Contacts/SearchForm_advanced.tpl', 604, false),array('modifier', 'default', 'cache/modules/Contacts/SearchForm_advanced.tpl', 193, false),array('modifier', 'escape', 'cache/modules/Contacts/SearchForm_advanced.tpl', 206, false),)), $this); ?>
...
<tr>
		...
		<?php if ($this->_tpl_vars['fields']['contact_id_advanced']['acl'] > 0): ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='contact_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_ID','module' => 'Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['contact_id_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['contact_id_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['contact_id_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['contact_id_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['contact_id_advanced']['name']; ?>
' size='30' 
    maxlength='36' 
...
' title=''      accesskey='9'  >
		...
		<?php if ($this->_tpl_vars['fields']['full_student_name_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='full_student_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_FULL_NAME','module' => 'Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['full_student_name_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['full_student_name_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['full_student_name_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['full_student_name_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['full_student_name_advanced']['name']; ?>
' size='30' 
    maxlength='250' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
' title=''      >
		...
		<?php if ($this->_tpl_vars['fields']['birthdate_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
<?php $this->assign('id', $this->_tpl_vars['fields']['birthdate_advanced']['name']); ?>

<?php if (isset ( $_REQUEST['birthdate_advanced_range_choice'] )): ?>
<?php $this->assign('starting_choice', $_REQUEST['birthdate_advanced_range_choice']); ?>
<?php else: ?>
...
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['birthdate_advanced']['options'],'selected' => $this->_tpl_vars['starting_choice']), $this);?>

</select>
</div>

<div id="<?php echo $this->_tpl_vars['id']; ?>
_range_div" style="<?php if (preg_match ( '/^\[/' , $_REQUEST['range_birthdate_advanced'] ) || $this->_tpl_vars['starting_choice'] == 'between'): ?>display:none<?php else: ?>display:''<?php endif; ?>;">
<input autocomplete="off" type="text" name="range_<?php echo $this->_tpl_vars['id']; ?>
" id="range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php if (empty ( $_REQUEST['range_birthdate_advanced'] ) && ! empty ( $_REQUEST['birthdate_advanced'] )):  echo $_REQUEST['birthdate_advanced'];  else:  echo $_REQUEST['range_birthdate_advanced'];  endif; ?>' title=''   size="11" style="width:100px !important;">
...
" value='<?php echo $_REQUEST['start_range_birthdate_advanced']; ?>
...
" value='<?php echo $_REQUEST['end_range_birthdate_advanced']; ?>
...
<?php echo smarty_function_html_options(array('id' => 'assigned_user_id_advanced','name' => 'assigned_user_id_advanced[]','options' => $this->_tpl_vars['fields']['assigned_user_id_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['assigned_user_id_advanced']['value']), $this);?>
		...
		<?php if ($this->_tpl_vars['fields']['contact_status_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='contact_status_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_STATUS','module' => 'Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('id' => 'contact_status_advanced','name' => 'contact_status_advanced[]','options' => $this->_tpl_vars['fields']['contact_status_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['contact_status_advanced']['value']), $this);?>
...
<?php echo smarty_function_html_options(array('id' => 'lead_source_advanced','name' => 'lead_source_advanced[]','options' => $this->_tpl_vars['fields']['lead_source_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['lead_source_advanced']['value']), $this);?>
		...
		<?php if ($this->_tpl_vars['fields']['campaign_name_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='team_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TEAMS','module' => 'Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<?php echo smarty_function_sugarvar_teamset(array('parentFieldArray' => 'fields','vardef' => $this->_tpl_vars['fields']['team_name'],'tabindex' => 1,'display' => '','labelSpan' => '','fieldSpan' => '','formName' => 'search_form','displayType' => 'renderSearchView'), $this);?>
		...
		<?php if ($this->_tpl_vars['fields']['j_school_contacts_1_name_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='j_school_contacts_1_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_J_SCHOOL_CONTACTS_1_FROM_J_SCHOOL_TITLE','module' => 'Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['j_school_contacts_1_name_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['j_school_contacts_1_name_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['j_school_contacts_1_name_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['j_school_contacts_1j_school_ida_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['j_school_contacts_1j_school_ida_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['j_school_contacts_1_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['j_school_contacts_1_name_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"j_school_contacts_1j_school_ida_advanced","name":"j_school_contacts_1_name_advanced"}}'; ?>
, "single", true);'><?php echo smarty_function_sugar_getimage(array('alt' => $this->_tpl_vars['app_strings']['LBL_ID_FF_SELECT'],'name' => "id-ff-select",'ext' => ".png",'other_attributes' => ''), $this);?>
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['j_school_contacts_1_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['j_school_contacts_1_name_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['j_school_contacts_1j_school_ida_advanced']['name']; ?>
.value = '';" value="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_LABEL']; ?>
"><?php echo smarty_function_sugar_getimage(array('name' => "id-ff-clear",'alt' => $this->_tpl_vars['app_strings']['LBL_ID_FF_CLEAR'],'ext' => ".png",'other_attributes' => ''), $this);?>
</button>
</span>
...
' title=''      >
		...
		<?php if ($this->_tpl_vars['fields']['portal_active_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='portal_active_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PORTAL_ACTIVE','module' => 'Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<?php if (strval ( $this->_tpl_vars['fields']['portal_active_advanced']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED'); ?>
<?php elseif (strval ( $this->_tpl_vars['fields']['portal_active_advanced']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED'); ?>
<?php else: ?>
	<?php $this->assign('default', 'SELECTED'); ?>
<?php endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['portal_active_advanced']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['portal_active_advanced']['name']; ?>
"   >
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='current_user_only_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENT_USER_FILTER','module' => 'Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
