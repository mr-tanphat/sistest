<?php /* Smarty version 2.6.11, created on 2017-02-07 09:53:28
         compiled from modules/bc_survey/license/tpls/license.tpl */ ?>
...
<script type="text/javascript">
    ...
    if (typeof(jQuery) == \'undefined\') {
        ...
        getScript(\'';  echo $this->_tpl_vars['file_path'];  echo '\', function() {
    ...
    {
        var curl_not_enabled = \'';  echo $this->_tpl_vars['CURL_NOT_ENABLED'];  echo '\';
        if(curl_not_enabled) {
';  if ($this->_tpl_vars['IS_SUGAR_6'] == true):  echo '
...
';  endif;  echo '
        ...
        $.ajax(\'index.php?module=';  echo $this->_tpl_vars['MODULE'];  echo '&action=outfitterscontroller&to_pdf=1\',{
            type: \'POST\',
            dataType: \'json\',
            data: {
                method: \'validate\',
...
<?php endif;  echo '
                    ...
                    if(response.licensed_user_count != undefined) {
                        ...
                        if(response.validated_users == true) {
                            ...
                            $(\'#btn-outfitters-increase\').html(\'Increase to ';  echo $this->_tpl_vars['current_users'];  echo ' users\');
...
';  endif;  echo '
    ...
    {
';  if ($this->_tpl_vars['validate_users'] == true && $this->_tpl_vars['manage_licensed_users'] == true):  echo '
...
';  if ($this->_tpl_vars['validate_users'] == true && $this->_tpl_vars['manage_licensed_users'] == true):  echo '
    ...
    function outfitters_save_licensed_users()
    {
        ...
        if(avail_users < 0)
        {
            ...
            $(\'#outfitters_save_licensed_users_fail_message\').html(\'';  echo $this->_tpl_vars['LICENSE']['LBL_ERROR_TOO_MANY_USERS'];  echo '\');
            return false;
        }
...
';  endif;  echo '
    ...
    {
';  if ($this->_tpl_vars['IS_SUGAR_6'] == true):  echo '
        window.location=\'';  echo $this->_tpl_vars['continue_url'];  echo '\';
';  else:  echo '
        var app = window.parent.SUGAR.App;
        app.router.navigate(\'';  echo $this->_tpl_vars['continue_url'];  echo '\', {trigger:true, replace:true});
';  endif;  echo '
    }
</script>
<style type="text/css">
